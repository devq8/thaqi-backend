...
from chatbot.views import ChatListView, ChatListPublicView, ChatCreateView, ChatUpdateView, ChatDestroyView
from chatbot.views import MessageListView, MessagePublicListView, MessageCreateView, MessageUpdateView, MessageDestroyView

urlpatterns = [
    ############### Chats ###############
    path('chats/', ChatListView.as_view(), name='chat_list'),
    path('chats/public/', ChatListPublicView.as_view(), name='chat_list'),
    ...
    path('chats/<int:chat_id>/messages/public/', MessagePublicListView.as_view(), name='message_list'),
